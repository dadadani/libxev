// This file is required until https://github.com/ziglang/zig/issues/21200 and https://github.com/ziglang/zig/pull/21218 are fixed
...
pub const mach_msg_header_t = @typeInfo(@typeInfo(@typeInfo(@TypeOf(std.c.mach_msg)).@"fn".params[0].type.?).optional.child).pointer.child;
